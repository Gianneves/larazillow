    ...
    <Box>
        ...
        <div>
            <form @submit.prevent="makeOffer">
                ...
                <input v-model.number="form.amount" type="range" :min="min" :max="max" step="10000" class="mt-2 w-full h-4 bg-gray-200 rounded-lg apperance-none cursor-pointer dark:bg-gray-700">
